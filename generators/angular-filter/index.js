...
let AngularFilterGenerator = class extends Generator {
  constructor(args, opts) {
    super(args, opts);
  }
  initializing() {
    this.log(chalk.white('APE-Stack Angular Filter'));
  }
  prompting() {
    ...
    let prompts = [{
      ...
      message: 'Enter a short description of this filter (optional)',
      default: '[Description]'
    }];
  ...
  writing() {
    ...
    this.log(chalk.magenta('Finished creating filter'));
  }
};

module.exports = AngularFilterGenerator;
