...
var FilterGenerator = yeoman.generators.NamedBase.extend({
    ...
    renderFile: function() {
        this.template('_.filter.js', format('client/{0}/{1}.filter.js', this.slugifiedModuleName, this.slugifiedName));
        this.template('_.filter.spec.js', format('client/{0}/tests/{1}.filter.spec.js', this.slugifiedModuleName, this.slugifiedName));
    }
});
