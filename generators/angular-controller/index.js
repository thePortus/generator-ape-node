...
var ControllerGenerator = yeoman.generators.NamedBase.extend({
    ...
    renderFiles: function() {
        this.template('_.controller.js', format('client/{0}/{1}.controller.js', this.slugifiedModuleName, this.slugifiedControllerName));
        this.template('_.controller.spec.js', format('client/{0}/tests/{1}.controller.spec.js', this.slugifiedModuleName, this.slugifiedControllerName));
    }
});
